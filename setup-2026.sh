...
declare -A MOD_DESC=(
  ...
  ["httpx"]="⚡ httpx (Conjunto de utilitários HTTP rápido e multiuso)"
  ...
  ["lolcat"]="🌈 lolcat (Rainbow terminal output)"
