...
if ! command -v gum &> /dev/null; then
    ...
    wget -qO "$TMP_GUM_DIR/gum.tar.gz" https://github.com/charmbracelet/gum/releases/download/v0.13.0/gum_0.13.0_linux_x86_64.tar.gz # NOSONAR
...
declare -A MOD_DESC=(
  ...
  ["curlie"]="🦱 Curlie (curl + httpie)" # NOSONAR
